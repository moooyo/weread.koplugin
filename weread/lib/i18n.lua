...
local zh = {
    ["Download paused. Completed chapters have been saved.\nPlease cache the book again later to continue."] = "下载已暂停，已完成章节已保存。\n请稍后重新缓存以继续下载。",
    ["Service response: HTTP %1"] = "服务响应：HTTP %1",
    ["Please check your login and book access before continuing."] = "请检查登录状态和书籍访问权限后再继续。",
    ["Not enough memory. Close other tasks and try again."] = "可用内存不足，请关闭其他任务后重试。",
    ["Background downloading is unavailable."] = "后台下载暂不可用。",
    ["Caching chapters: %1/%2 (%3 active)"] = "正在缓存章节：%1/%2（%3 章下载中）",
    ["Retrying chapter %1/%2 (attempt %3/%4)"] = "正在重试第 %1/%2 章（第 %3/%4 次尝试）",
    ["Waiting for reading sync to finish..."] = "正在等待阅读同步完成…",
    ["Reading sync did not finish. Please retry the download."] = "阅读同步尚未结束，请稍后重新缓存。",
    ["Some images could not be downloaded. Download again to retry the affected chapters."] = "部分图片下载失败，再次下载可重试受影响的章节。",
    ["Reusing cached chapter %1/%2"] = "正在复用已缓存正文 %1/%2 章",
    ["Background annotation download is unavailable; downloading in the foreground."] = "后台注释下载不可用，正在前台下载。",
    ...
    ["Concurrent chapter downloads: %1"] = "并发下载章节数：%1",
    ["%1 chapter(s)"] = "%1 章",
    ["Changes apply to new download jobs."] = "修改仅对之后启动的下载任务生效。",
    ["Book images"] = "书籍图片",
